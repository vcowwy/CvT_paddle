...
class Scheduler:
    ...
    * At the END of each optimizer update, after incrementing the update count, to calculate next update's value
    ...
    def __init__(self, optimizer, param_group_field: str, noise_range_t=\
        None, noise_type='normal', noise_pct=0.67, noise_std=1.0,
        noise_seed=None, initialize: bool=True) ->None:
    ...
    def _add_noise(self, lrs, t):
        if self.noise_range_t is not None:
            ...
            if apply_noise:
                ...
                g = paddle.seed(self.noise_seed + t)
                if self.noise_type == 'normal':
                    while True:
                        #noise = torch2paddle.randn(1, generator=g).item()
